...
saveRDS(
  ...
  file.path(
    dir_model,
    "model_corn_no_sequential_interaction.rds"
  )
)
#save soy model
saveRDS(
  ...
  file.path(
    dir_model,
    "model_soy_no_sequential_interaction.rds"
  ))
...
saveRDS(
  ...
  file.path(
    dir_model,
    "model_wheat_us_no_sequential_interaction.rds"
  ))
...
saveRDS(
  ...
  file.path(
    dir_model,
    "model_wheat_eu_no_sequential_interaction.rds"
  ))
#======================================================================