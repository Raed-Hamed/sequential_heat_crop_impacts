...
def compute_frequency_change(path_input):
    ...
    for file in file_list:
        ...
        new_file1 = new_file.replace("spring/wtsp_", "coincide_")
...
def compute_f_mean_per_model(path):
    ...
    for idx, file in enumerate(files_his):
        ...
        _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, reference, percentile, f_increase, ssp,filename = file.split('/')
        _, _, _, model, _, _, nr_percen = filename.split('_')
        
        mean_counties = fct_mean_per_county(ds, model, 'f_change', crops_shapefile)
        
        crops_shapefile['M_'+str(idx)] = mean_counties
...
# path_future = '/Users/carmenst/Documents/Polybox/WCR/Conferences_summerschools/2022_10_Como/Project/Sequential_heat_crops/Data/Climate/CMIP6/wheat/future/input/**/*' 
# nr_years = 40
...
# path_historic = '/Users/carmenst/Documents/Polybox/WCR/Conferences_summerschools/2022_10_Como/Project/Sequential_heat_crops/Data/Climate/CMIP6/wheat/historic/input/**/*' 
...
# path_future_output = '/Users/carmenst/Documents/Polybox/WCR/Conferences_summerschools/2022_10_Como/Project/Sequential_heat_crops/Data/Climate/CMIP6/wheat/future/output/**/*' 
...
# #ssps= ['ssp245', 'ssp370']
# ssps= ['ssp119', 'ssp126']
ssps= ['ssp119', 'ssp126', 'ssp245', 'ssp370']
...
for percentile in percentiles: 
    ...
    for reference in references:
        ...
        # frequency change
        path_scenario = '/Users/carmenst/Documents/Polybox/WCR/Conferences_summerschools/2022_10_Como/Project/Sequential_heat_crops/Data/Climate/CMIP6/wheat/frequencies' +(
        ...
        for ssp in ssps:
            ...
            path_cooccurrence = '/Users/carmenst/Documents/Polybox/WCR/Conferences_summerschools/2022_10_Como/Project/Sequential_heat_crops/Data/Climate/CMIP6/wheat/frequencies' + (
                reference_str+ percentile_str +'/frequency')
            comparison_fut_his(path_cooccurrence, ssp)
            
            # compare changes in co-occurence
            path = '/Users/carmenst/Documents/Polybox/WCR/Conferences_summerschools/2022_10_Como/Project/Sequential_heat_crops/Data/Climate/CMIP6/wheat/frequencies/'+(
                reference_str+percentile_str +'/frequency increase/'+ssp)
            # compute_f_mean(path)
            compute_f_mean_per_model(path)
...
# import copy
# # # us_shp_file ='/Users/carmenst/Documents/Polybox/WCR/Conferences_summerschools/2022_10_Como/Project/Sequential_heat_crops/Data/shapefiles/output/2023_06_13_T_diff/counties_difference_per_model.shp'

# scenario = 'f_change_relative_ssp119_reference_future_percentile_50.shp'
# us_shp_file ='/Users/carmenst/Documents/Polybox/WCR/Conferences_summerschools/2022_10_Como/Project/Sequential_heat_crops/Data/shapefiles/output/2023_08_18_f_chage_per_model/'+scenario
# shp_US = gpd.read_file(us_shp_file)
