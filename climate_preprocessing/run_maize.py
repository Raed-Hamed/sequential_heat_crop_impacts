...
import xarray as xr
import numpy as np
from preprocessing_functions import read_t_data, read_moisture, from_planting_date, kdd_gdd_per_months, save_outputs
...
grid_cells = np.where(~np.isnan(planting)) #grid cells with a harvest day
...
filename_output = 'maize_kdd_gdd_tmax_sm.nc'                                                     
