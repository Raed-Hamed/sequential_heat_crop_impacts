...
plot_soy_coef <- local_coef_plot(boot_soy_model) +
  ...
  ggtitle(label = "Sensitivity of soybean yield to soil moisture and temperature variations",
          subtitle = "") +
  coord_sf(crs = "+proj=lcc +lon_0=-90 +lat_1=33 +lat_2=45")
#----------------------------------------------------------------------
#maize US plot
plot_corn_coef <- local_coef_plot(boot_corn_model) +
  geom_sf(
    data = us_state_shp,
    color = "black",
    size = 0.00000001,
  ...
  coord_sf(xlim = c(-125, -75), ylim = c(25, 50)) +
  ggtitle(label = "Sensitivity of maize yield to soil moisture and temperature variations",
          subtitle = "") +
  coord_sf(crs = "+proj=lcc +lon_0=-90 +lat_1=33 +lat_2=45")
#----------------------------------------------------------------------
#Wheat US plot
plot_wheat_us_coef <- local_coef_plot(boot_wheat_us_model) +
  ...
  coord_sf(xlim = c(-125,-75), ylim = c(25, 50)) +
  ggtitle(label = "Sensitivity of wheat yield to soil moisture and temperature variations",
          subtitle = "") +
  coord_sf(crs = "+proj=lcc +lon_0=-90 +lat_1=33 +lat_2=45")
#----------------------------------------------------------------------
#Wheat EU plot
